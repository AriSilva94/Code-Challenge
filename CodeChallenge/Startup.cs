...
namespace CodeChallenge
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CadastroCargueiroContext>(options =>
                options.UseMySql(Configuration.GetConnectionString("CodeChallengeContext"), builder =>
                builder.MigrationsAssembly("CodeChallenge")));
